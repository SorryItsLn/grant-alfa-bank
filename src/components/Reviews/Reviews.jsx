      ...
      <div className="mt-6 grid  grid-cols-12 gap-2 ">
        ...
        <div className="col-span-3">
          <ReviewCard
            ...
            work={"УБРиР"}
            description={
              "«Благодаря практичному мышлению и гибкости в решении задач, которые требовались выполнить в сжатые сроки, команда голосового робота Zvonobot смогла высоко проявить свою компетентность и эффективность»"
            }
        ...
        <div className="col-span-3">
          <ReviewCard
            ...
            description={
              "«У нас с внедрением Zvonobot выросло количество сотрудников в 2 раза, что позволило и самим расти в качестве, а также в самых лучших показателях, которые можно придумать»."
            }
